...
var globalConfig = {
    ...
    URLS: {
        ...
        CONCERO_DEPLOYMENTS: "https://raw.githubusercontent.com/concero/v2-contracts/refs/heads/".concat((_process_env_DEPLOYMENTS_SERVICE_GIT_BRANCH = process.env.DEPLOYMENTS_SERVICE_GIT_BRANCH) !== null && _process_env_DEPLOYMENTS_SERVICE_GIT_BRANCH !== void 0 ? _process_env_DEPLOYMENTS_SERVICE_GIT_BRANCH : "master", "/.env.deployments.").concat(getEnvVar("NETWORK_MODE") === "localhost" || getEnvVar("NETWORK_MODE") === "testnet" ? "testnet" : "mainnet"),
        V2_NETWORKS: {
