...
import { BlockManagerRegistry, DeploymentManager, NetworkManager, TxManager, ViemClientManager } from "../../common/managers";
    ...
    return _async_to_generator(function() {
        ...
        return _ts_generator(this, function(_state) {
            ...
            for(i = 0; i < decodedCLFReport.report.results.length; i++){
                try {
                    decodedResult = decodeMessageReportResult(decodedCLFReport.report.results[i]);
        ...
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                ...
                case 3:
                    ...
                    decodedDstChainData = decodeAbiParameters([
 ...
 */ export function submitCLFMessageReport(logs, network) {
    return _async_to_generator(function() {
        ...
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    ...
                    logger = Logger.getInstance().getLogger("processMessageReports");
                ...
                case 1:
                    ...
                    // Decode the logs
                    decodedLogs = decodeLogs(logs, globalConfig.ABI.CONCERO_VERIFIER);
                    return [
                        4,
 ...
 */ function processMessageReports(logs) {
    return _async_to_generator(function() {
        ...
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    logger = Logger.getInstance().getLogger("submitCLFMessageReport");
