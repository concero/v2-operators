...
export var BlockCheckpointManager = /*#__PURE__*/ function(ManagerBase) {
    "use strict";
    _inherits(BlockCheckpointManager, ManagerBase);
    function BlockCheckpointManager() {
        _class_call_check(this, BlockCheckpointManager);
        var _this;
        _this = _call_super(this, BlockCheckpointManager), _define_property(_this, "prisma", DbManager.getClient()), _define_property(_this, "logger", void 0);
        _this.logger = Logger.getInstance().getLogger("BlockCheckpointManager");
        return _this;
    }
