...
export var BlockManagerRegistry = /*#__PURE__*/ function(ManagerBase) {
    "use strict";
    ...
    function BlockManagerRegistry(blockCheckpointManager, networkManager, viemClientManager, rpcManager) {
        ...
        _this.logger = Logger.getInstance().getLogger("BlockManagerRegistry");
        return _this;
    }
                    ...
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                ...
                                return [
                                    4,
                                    BlockManager.create(network, publicClient, this.blockCheckpointManager)
                                ];
                            case 1:
                                blockManager = _state.sent();
