...
var _globalConfig_HTTPCLIENT = globalConfig.HTTPCLIENT, RETRY_DELAY = _globalConfig_HTTPCLIENT.RETRY_DELAY, MAX_RETRIES = _globalConfig_HTTPCLIENT.MAX_RETRIES, DEFAULT_TIMEOUT = _globalConfig_HTTPCLIENT.DEFAULT_TIMEOUT;
export var HttpClient = /*#__PURE__*/ function(ManagerBase) {
    "use strict";
    ...
    function HttpClient(maxConcurrentRequests) {
        ...
        _this.logger = Logger.getInstance().getLogger("HttpClient");
        return _this;
    }
                ...
                return _async_to_generator(function(method, url) {
                    ...
                    return _ts_generator(this, function(_state) {
                        ...
                        if (!this.initialized || !this.axiosInstance) {
                            throw new AppError(AppErrorEnum.FailedHTTPRequest, new Error("HttpClient not initialized"));
                        }
                        return [
                            2,
