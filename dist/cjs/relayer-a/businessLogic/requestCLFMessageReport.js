...
Object.defineProperty(exports, "requestCLFMessageReport", {
    enumerable: true,
    get: function() {
        return requestCLFMessageReport;
    }
});
...
function requestCLFMessageReport(logs, network) {
        ...
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    ...
                    logger = _utils.Logger.getInstance().getLogger("requestCLFMessageReport");
                    ...
                    return [
                        4,
                        _managers.DeploymentManager.getInstance().getConceroVerifier()
                    ];
                case 1:
                    verifierAddress = _state.sent();
                    _ViemClientManager_getInstance_getClients = _managers.ViemClientManager.getInstance().getClients(verifierNetwork), publicClient = _ViemClientManager_getInstance_getClients.publicClient, walletClient = _ViemClientManager_getInstance_getClients.walletClient;
                    _state.label = 2;
                case 2:
                    _state.trys.push([
                        2,
                    ...
                    decodedLogs = (0, _decodeLogs.decodeLogs)(logs, _constants.globalConfig.ABI.CONCERO_ROUTER);
                    promises = [];
        ...
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    ...
                    encodedSrcChainData = (0, _viem.encodeAbiParameters)([
                        {
                            type: "tuple",
                            components: [
                                {
                    ...
                    if (_constants.globalConfig.TX_MANAGER.DRY_RUN) {
                        ...
                        _constants.eventEmitter.emit("requestMessageReport", {
                            txHash: dryRunTxHash
                        });
                        return [
                            2
                    ...
                    return [
                        4,
                        _managers.TxManager.getInstance().callContract(walletClient, publicClient, verifierNetwork, {
                            address: verifierAddress,
                            abi: _constants.globalConfig.ABI.CONCERO_VERIFIER,
                            functionName: "requestMessageReport",
                            args: [
                                messageId,
                                (0, _viem.keccak256)(message),
                                srcChainSelector,
                                encodedSrcChainData
                            ],
                ...
                case 2:
                    ...
                    _constants.eventEmitter.emit("requestMessageReportError", {
