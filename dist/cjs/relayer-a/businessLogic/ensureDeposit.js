...
Object.defineProperty(exports, "ensureDeposit", {
    enumerable: true,
    get: function() {
        return ensureDeposit;
    }
});
...
function fetchDepositAndDepositIfNeeded() {
    return _async_to_generator(function() {
        ...
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    logger = _.Logger.getInstance().getLogger("ensureDeposit");
                ...
                case 3:
                    ...
                    return [
                        4,
                        (0, _utils.callContract)(publicClient, walletClient, {
