...
Object.defineProperty(exports, "setupEventListeners", {
    enumerable: true,
    get: function() {
...
var _requestCLFMessageReport = require("../businessLogic/requestCLFMessageReport");
var _submitCLFMessageReport = require("../businessLogic/submitCLFMessageReport");
...
function setupEventListeners() {
    return _async_to_generator(function() {
        ...
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    logger = _utils.Logger.getInstance().getLogger("setupEventListeners");
                ...
                case 4:
                    ...
                    sentEvent = (0, _viem.getAbiItem)({
                        abi: _constants.globalConfig.ABI.CONCERO_ROUTER,
                        name: "ConceroMessageSent"
                    });
                    return [
                        4,
                        (0, _setupEventListener.setupEventListener)(network, routerAddress, _requestCLFMessageReport.requestCLFMessageReport, sentEvent)
                    ];
                case 5:
                ...
                case 13:
                    ...
                    messageReportEvent = (0, _viem.getAbiItem)({
                        abi: _constants.globalConfig.ABI.CONCERO_VERIFIER,
                        name: "MessageReport"
                    });
                    return [
                        4,
                        (0, _setupEventListener.setupEventListener)(verifierNetwork, verifierAddress, _submitCLFMessageReport.submitCLFMessageReport, messageReportEvent)
                    ];
                case 14:
