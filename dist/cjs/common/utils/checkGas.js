...
_export(exports, {
    ...
    get getChainOperatorMinBalance () {
        return getChainOperatorMinBalance;
    }
});
        ...
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    ...
                    if (!_constants.globalConfig.NOTIFICATIONS.SLACK.MONITORING_SYSTEM_CHANNEL_ID || !_constants.globalConfig.NOTIFICATIONS.SLACK.BOT_TOKEN) {
                        return [
                            2
                        ];
                    }
                    webClient = new _webapi.WebClient(_constants.globalConfig.NOTIFICATIONS.SLACK.BOT_TOKEN);
                    return [
                        4,
                        webClient.chat.postMessage({
                            channel: _constants.globalConfig.NOTIFICATIONS.SLACK.MONITORING_SYSTEM_CHANNEL_ID,
                            text: message
                        })
                    ];
                case 1:
...
function getChainOperatorMinBalance(publicClient) {
    return _async_to_generator(function() {
        ...
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                ...
                case 1:
                    ...
                    averageTxCostInWei = currentGasPrice * _constants.globalConfig.TX_MANAGER.GAS_LIMIT.DEFAULT;
                    return [
                        2,
...
function checkAndNotifyInsufficientGas() {
    return _async_to_generator(function() {
        ...
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    operatorAddress = _constants.globalConfig.OPERATOR_ADDRESS;
                    viemClientManager = _managers.ViemClientManager.getInstance();
                    networkManager = _managers.NetworkManager.getInstance();
                    logger = _logger.Logger.getInstance().getLogger("GasChecker");
                    _state.label = 1;
                case 1:
                    _state.trys.push([
                        1,
                ...
                case 4:
                    ...
                    message = "Insufficient gas on ".concat(network.name, " (chain ID: ").concat(network.id, "). Minimum required: ").concat((0, _viem.formatUnits)(operatorMinBalance, 18), ", actual: ").concat((0, _viem.formatUnits)(balance, 18));
                    return [
                        4,
        ...
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                ...
                case 1:
                    ...
                    }, _constants.globalConfig.NOTIFICATIONS.INTERVAL);
                    return [
                        2
                    ];
            }
