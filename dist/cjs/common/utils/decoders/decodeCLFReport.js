...
Object.defineProperty(exports, "decodeCLFReport", {
    enumerable: true,
    get: function() {
        return decodeCLFReport;
    }
});
var _viem = require("viem");
var clfReportSubmissionAbi = (0, _viem.parseAbiParameters)([
...
var clfReportAbi = (0, _viem.parseAbiParameters)([
    "bytes32[] requestIds",
    "bytes[] results",
    "bytes[] errors",
...
function decodeCLFReport(tx) {
    ...
    var decodedData = (0, _viem.decodeAbiParameters)(clfReportSubmissionAbi, "0x".concat(inputData));
    // Extract and decode the report
    var reportBytes = decodedData[1];
    var decodedReport = (0, _viem.decodeAbiParameters)(clfReportAbi, reportBytes);
