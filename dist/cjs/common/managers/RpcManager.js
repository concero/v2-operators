...
Object.defineProperty(exports, "RpcManager", {
    enumerable: true,
    get: function() {
        return RpcManager;
    }
...
var RpcManager = /*#__PURE__*/ function(ManagerBase) {
    "use strict";
    ...
    function RpcManager() {
        ...
        _this.logger = _1.Logger.getInstance().getLogger("RpcManager");
        return _this;
    }
                    ...
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                ...
                                rpcOverride = _.globalConfig.RPC.OVERRIDE[chainId.toString()];
                                ...
                                url = "".concat(_.globalConfig.URLS.CONCERO_RPCS).concat(chainType, "/").concat(chainId, "-").concat(chainName, ".json");
                                return [
                                    4,
                            ...
                            case 2:
                                ...
                                urls = response.urls;
                                rpcsExtension = _.globalConfig.RPC.EXTENSION[chainId.toString()];
                                if (rpcsExtension) {
