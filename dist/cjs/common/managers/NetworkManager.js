...
var NetworkManager = /*#__PURE__*/ function(ManagerBase) {
    "use strict";
    ...
    function NetworkManager(rpcManager, deploymentsManager) {
        ...
        _this.logger = _1.Logger.getInstance().getLogger("NetworkManager");
    ...
    _create_class(NetworkManager, [
        ...
        },
        {
            ...
            value: function getVerifierNetwork() {
                if (_.globalConfig.NETWORK_MODE === "mainnet") {
                    return this.mainnetNetworks["arbitrum"];
                } else if (_.globalConfig.NETWORK_MODE === "testnet") {
                    return this.testnetNetworks["arbitrumSepolia"];
                } else if (_.globalConfig.NETWORK_MODE === "localhost") {
                    return this.testnetNetworks["localhost"];
                } else {
                    throw new Error("Unsupported network mode: ".concat(_.globalConfig.NETWORK_MODE));
                }
            }
        },
        {
        ...
        },
        {
            ...
            value: function setupUpdateCycle() {
                ...
                }, _.globalConfig.NETWORK_MANAGER.NETWORK_UPDATE_INTERVAL_MS);
            }
        },
        {
            key: "updateNetworks",
                    ...
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            ...
                            case 1:
                                ...
                                this.activeNetworks = this.filterNetworks(_.globalConfig.NETWORK_MODE);
                ...
                return Object.fromEntries(Object.entries(networks).map(function(param) {
                    ...
                    return [
                        networkKey,
                        {
                            ...
                            confirmations: _.globalConfig.TX_MANAGER.DEFAULT_CONFIRMATIONS,
            ...
            value: function getTestingNetworks(operatorPK) {
                return {
                    localhost: {
                        ...
                        chainSelector: "1",
                        confirmations: _.globalConfig.TX_MANAGER.DEFAULT_CONFIRMATIONS,
                        viemChain: _1.localhostViemChain
                    },
                    localhostPolygon: {
                        name: "localhost",
                        type: "localhost",
        ...
        },
        {
            ...
            value: function filterNetworks(networkType) {
                var networks = [];
                var ignoredIds = _.globalConfig.IGNORED_NETWORK_IDS || [];
                var whitelistedIds = _.globalConfig.WHITELISTED_NETWORK_IDS[networkType] || [];
                switch(networkType){
                    case "localhost":
                        networks = Object.values(this.getTestingNetworks((0, _1.getEnvVar)("OPERATOR_PRIVATE_KEY")));
                        break;
                    case "testnet":
