...
Object.defineProperty(exports, "TxWriter", {
    enumerable: true,
    get: function() {
        return TxWriter;
    }
...
var TxWriter = /*#__PURE__*/ function() {
    "use strict";
    function TxWriter(networkManager, viemClientManager) {
        ...
        this.logger = _utils.Logger.getInstance().getLogger("TxWriter");
    }
                    ...
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            ...
                            case 1:
                                ...
                                return [
                                    4,
                                    (0, _utils.callContract)(publicClient, walletClient, params)
                                ];
                            case 2:
                                txHash = _state.sent();
