...
Object.defineProperty(exports, "DeploymentManager", {
    enumerable: true,
    get: function() {
...
var DeploymentManager = /*#__PURE__*/ function(ManagerBase) {
    "use strict";
    ...
    function DeploymentManager() {
        ...
        _this.httpClient = _httpClient.HttpClient.getQueueInstance();
        _this.logger = _logger.Logger.getInstance().getLogger("DeploymentManager");
        return _this;
    }
    _create_class(DeploymentManager, [
                        ...
                        switch(_state.label){
                            case 0:
                                if (this.isLocalhostEnv()) {
                                    return [
                                        2,
                                        (0, _getEnvVar.getEnvVar)("CONCERO_ROUTER_PROXY_LOCALHOST")
                                    ];
                                }
                ...
                return _async_to_generator(function() {
                    ...
                    return _ts_generator(this, function(_state) {
                        if (this.isLocalhostEnv()) {
                            return [
                                2,
                                _define_property({}, (0, _getEnvVar.getEnvVar)("LOCALHOST_FORK_CHAIN_ID"), (0, _getEnvVar.getEnvVar)("CONCERO_ROUTER_PROXY_LOCALHOST"))
                            ];
                        }
                        ...
                        switch(_state.label){
                            case 0:
                                if (this.isLocalhostEnv()) {
                                    return [
                                        2,
                                        (0, _getEnvVar.getEnvVar)("CONCERO_VERIFIER_PROXY_LOCALHOST")
                                    ];
                                }
                    ...
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            ...
                            case 1:
                                ...
                                return [
                                    4,
                                    this.httpClient.get(_constants.globalConfig.URLS.CONCERO_DEPLOYMENTS, {
                                        responseType: "text"
                                    })
                                ];
                            case 2:
                                ...
                                verifierEntry = deploymentsEnvArr.find(function(d) {
                                    var networkSuffix = _constants.globalConfig.NETWORK_MODE === "testnet" ? "ARBITRUM_SEPOLIA" : "ARBITRUM";
        ...
        },
        {
            ...
            value: function isLocalhostEnv() {
                return _constants.globalConfig.NETWORK_MODE === "localhost";
            }
        },
        {
            key: "dispose",
