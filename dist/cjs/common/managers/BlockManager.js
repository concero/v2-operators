...
Object.defineProperty(exports, "BlockManager", {
    enumerable: true,
    get: function() {
        return BlockManager;
    }
...
var BlockManager = /*#__PURE__*/ function() {
    ...
    function BlockManager(initialBlock, network, publicClient, blockCheckpointManager) {
        ...
        _define_property(this, "pollingIntervalMs", _constants.globalConfig.BLOCK_MANAGER.POLLING_INTERVAL_MS);
        ...
        this.logger = _utils.Logger.getInstance().getLogger("BlockManager");
    }
                    ...
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            ...
                            case 3:
                                ...
                                endBlock = startBlock + _constants.globalConfig.BLOCK_MANAGER.CATCHUP_BATCH_SIZE - 1n > this.latestBlock ? this.latestBlock : startBlock + _constants.globalConfig.BLOCK_MANAGER.CATCHUP_BATCH_SIZE - 1n;
            ...
            value: function create(network, publicClient, blockCheckpointManager) {
                return _async_to_generator(function() {
                    ...
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                staticLogger = _utils.Logger.getInstance().getLogger("BlockManager");
                                if (!!_constants.globalConfig.BLOCK_MANAGER.USE_CHECKPOINTS) return [
                                    3,
                                    2
                                ];
                                return [
