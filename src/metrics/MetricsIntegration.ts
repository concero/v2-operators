...
export class MetricsIntegration {
  ...
  private setupEventListeners() {
    ...
    eventEmitter.on('requestMessageReportError', async (data: { 
      messageId: string; 
      error: string; 
      chainName: string 
    }) => {
    ...
    eventEmitter.on('submitMessageReportFinalized', async (data: {
      txHash: string;
      chainName: string;
      messageIds: string[];
    }) => {
    ...
    eventEmitter.on('submitMessageReportFailed', async (data: {
      txHash: string;
      chainName: string;
      messageIds: string[];
      error: string;
